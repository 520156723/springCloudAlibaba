package per.hqd.contentcenter.util;
...
public class JwtOperator {
    ...
    public String generateToken(Map<String, Object> claims) {
        ...
        return Jwts.builder()
            ...
            .signWith(key, SignatureAlgorithm.HS256) // 这里可以自定义算法: hs256对称加密，rsa非对称加密
            .compact();
    }
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2Mjc5MTY1NDUsImV4cCI6MTYyOTEyNjE0NX0.v2-YiHNsfJ7CMCUbfsxSWeq6sA2N1ADnYhdV1sTVV-U";
        ...
        System.out.println(claims);// 分别为id，iat：token什么时间生成的，过期时间

        // 将我改成你生成的token的第一段（以.为边界）
        String encodedHeader = "eyJhbGciOiJIUzI1NiJ9";
        // 测试4: 解密Header
        byte[] header = Base64.decodeBase64(encodedHeader.getBytes());
        System.out.println(new String(header) + " " + header.length);

        // 将我改成你生成的token的第二段（以.为边界）
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE2Mjc5MTY1NDUsImV4cCI6MTYyOTEyNjE0NX0";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload) + " " + payload.length);
